...
class EditTaskBottomSection extends StatelessWidget {
  final bool isFormValid;
  final bool hasChanges;
  final VoidCallback onCancel;
  final VoidCallback onSave;

  const EditTaskBottomSection({
    super.key,
              ...
              child: BlocBuilder<TaskBloc, TaskState>(
                builder: (context, state) {
                  ...
                  return ElevatedButton(
                    onPressed: isFormValid && hasChanges && !isLoading ? onSave : null,
                    ...
                    child: isLoading
                        ...
                        : Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              FaIcon(hasChanges ? FontAwesomeIcons.floppyDisk : FontAwesomeIcons.check, size: 16),
                              const SizedBox(width: 8),
                              Text(
