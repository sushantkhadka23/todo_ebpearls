              ...
              child: GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected
                        ? EditTaskUtils.getPriorityColor(priority).withOpacity(0.15)
                        : Theme.of(context).colorScheme.surfaceVariant.withOpacity(0.3),
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                      color: isSelected
                          ? EditTaskUtils.getPriorityColor(priority)
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: EditTaskUtils.getPriorityColor(priority).withOpacity(0.2),
                          borderRadius: BorderRadius.circular(8),
                        ),
                        child: FaIcon(
                          EditTaskUtils.getPriorityIcon(priority),
                          color: EditTaskUtils.getPriorityColor(priority),
                          size: 16,
                        ),
                      ),
